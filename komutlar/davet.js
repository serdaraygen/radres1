...
exports.run = (client, message) => {
  ...
  if (!message.guild) {
    ...
    .setColor(0xDF01A5)
        .addField('Botu Davet Et!', `[Tıkla!](https://discordapp.com/oauth2/authorize?client_id=536176264940224530&scope=bot&permissions=805314622)`, true)
        .addField('Destek Sunucusu!', `[Tıkla!](https://discord.gg/twWB4jG)`)
