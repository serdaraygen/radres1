...
client.ayarlar = {
	...
	prefix: "-", // Ön-ek
	token: "NTM2MTc2MjY0OTQwMjI0NTMw.DyduFQ.p0OADMgLMuLhgxgPUG10CpaTgWM",
	...
	yardimcilar: ["411906738808291328"], // İstenirse daha fazla eklenebilir. Eğer yoksa [] içi temizlenebilir.
	site: "", // Botunuzun web sitesi
  ...
  oyun: "{prefix}yardım | {sunucu} sunucu | {kullanıcı} kullanıcı {site} | ", // Minecraft Server:AÇIKSA (✅) KAPALIYSA (✘) | Oynuyor yeri, Burayı dilediğiniz şekilde değiştirebilirsiniz.
  ...
  durum: "rahatsizetmeyin" // Botun durumu sadece rahatsizetmeyin veya cevrimici veya bosta yazabilirsiniz eğer bunlar dışında bir şey yazarsanız veya boş bırakırsanız direk çevrimiçi gözükecektir.
...
exports.run = (client, message, args) => {
  if (message.author.id != "411906738808291328") return message.reply('Bunu Sadece Sahibim Kullanabilir');
